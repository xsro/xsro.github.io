...
\end{table}
从表中可以发现，$k_1$的条件与$k_2$和$L$都有关系，直观可以从图\ref{fig sta gain selection}

\begin{figure}[!htb]
	\centering
	\includegraphics[height=6cm]{simulation/out/k1-k2}
	\caption{不同文献中关于STA算法增益选取的讨论，途中x标记为\ref{fig basic sta}所使用的稳定的参数$L=0.1,k_1=0.18,k_2=0.2$，可以发现目前文献中的参数选取标准仍然是保守的。}
